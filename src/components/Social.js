...
export default function Social() {
  return (
    <div className="md:w-16 w-10 h-[20vh] md:h-30v p-1 top-20  rounded-bl-md rounded-tl-md bg-s-white  fixed md:top-[15%] right-0 text-s-white flex justify-center items-center cursor-pointer  flex-col ">
